            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="event">
                        <li>
                            <a href="../event/create_event.php">Add event</a>
                        </li>
                        <li>
                            <a href="../event/manageevent.php">Manage event</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="vote">
                        <li>
                            <a href="../voting/dashboard.php">view vote</a>
                        </li>
                        <li>
                            <a href="../voting/voting_creat.php">Add vote</a>
                        </li>
                    </ul>
                </li>
                <li>
