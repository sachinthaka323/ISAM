...
$sql="select * from even_create where id='$eid';";
        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    ...
                    <input type="text" name="event" class="form-control form-control-lg" value="<?php echo $row['event_name']; ?>"/>
                  </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    ...
                    <input type="date" name="date" class="form-control form-control-lg" value="<?php echo $row['date']; ?>"/>
                  </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="des_1" value="<?php echo $row['description_1']; ?>"></textarea>
                  </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="des_2" value="<?php echo $row['description_2']; ?>"></textarea>
                  </div>
             ...
             <div class="row">
              <div class="col mt-5"> -->
              Current specail status mode:<b><?php echo $row['special']; ?></b><br>
              <div class="row mt-4">
                <div class="col-md-6 mb-4">
                  <div class="form-check mt-2">
  ...
  if (in_array($fileActualExt, $allowed)) {
    if ($fileError === 0) {
     ...
     $event = $_POST['event'];
      ...
      $sql = "insert into even_create (event_name,date,description_1,description_2,permission,special,upload)
          values ('$event','$date','$des_1','$des_2','$permission','$special','$fileDesti');";
